...
// ---------- esp32 pins --------------
LoRa_E220 e32ttl(&Serial2, 15, 21, 19);  //  RX AUX_PIN M0 M1

//LoRa_E3220 e32ttl(&Serial2, 22, 4, 18, 21, 19, UART_BPS_RATE_9600); //  esp32 RX <-- e22 TX, esp32 TX --> e22 RX AUX_PIN M0 M1
// -------------------------------------
...
//LoRa_E32 e220ttl(&Serial2, 22, 4, 18, 21, 19, UART_BPS_RATE_9600); //  esp32 RX <-- e22 TX, esp32 TX --> e22 RX AUX_PIN M0 M1
// -------------------------------------
...
void setup() {
  ...
  */
  ...
  pinMode(AUX_PIN, INPUT);  //ESP32 pin 15
